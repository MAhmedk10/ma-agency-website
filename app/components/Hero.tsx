      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4 md:ml-8">
            <div className="inline-block px-4 py-2 rounded-full glass-card text-sm font-medium">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 pt-6 text-sm">
              <div>
        ...
        <div className="relative h-[400px] sm:h-[500px] md:h-[600px]">
          ...
          <div className="absolute top-0 right-0 w-64 sm:w-80 h-48 sm:h-64 glass-card glow-box p-4 sm:p-6 transform rotate-3 float-animation">
          ...
          <div className="absolute bottom-20 left-0 w-56 sm:w-72 h-44 sm:h-56 glass-card glow-box p-4 sm:p-6 transform -rotate-2 float-animation" style={{ animationDelay: '1s' }}>
